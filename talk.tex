\documentclass[pdf,SantaFe05talk,slideColor,colorBG,accumulate]{prosper}
...
\slideCaption{Electric Dipole Moments as Probes of $CPT$ Invariance}
...
\item
	...
	invariance
%	thus probing for New Physics at high energy scales
%\item
%	$ CPT $-breaking EDMs can be induced in Lorentz-violating
%	theories
\item  
...
%	where $ n^{\mu} = (1,0,0,0) $ is a vector background.
\vspace{-0.5cm}
\item
